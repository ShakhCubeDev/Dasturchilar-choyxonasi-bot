...
def _outside_start_text(lang: str, owned_groups: list[Any]) -> str:
    ...
    if group_lines:
        ...
        text += header + "\n".join(group_lines)
        tail = {
            "uz": "\n\nQulay boshqaruv uchun /panel yuboring yoki /group_reg group_id on|off ko'rinishida ishlating.",
            "ru": "\n\nДля удобного управления отправьте /panel или используйте команду /group_reg group_id on|off.",
